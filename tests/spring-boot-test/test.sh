...
# Script to test Spring Boot application with config-preflight

set -e

echo "=========================================="
echo "Testing Spring Boot with config-preflight"
echo "=========================================="
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
java -jar target/*.jar --spring.profiles.active=scenario1 2>&1 | head -50 || true
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
java -jar target/*.jar --spring.profiles.active=scenario2 2>&1 | head -50 || true
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
java -jar target/*.jar --spring.profiles.active=scenario3 2>&1 | head -50 || true
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
java -jar target/*.jar --spring.profiles.active=scenario4 2>&1 | head -50 || true
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
java -jar target/*.jar --spring.profiles.active=valid 2>&1 | head -50 || true
